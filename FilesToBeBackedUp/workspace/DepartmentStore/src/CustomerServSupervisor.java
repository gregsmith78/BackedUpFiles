...
public class CustomerServSupervisor extends Person{
	
	double salary;
	double totalSalary;
	
	public CustomerServSupervisor(String FirstName, String LastName, String Department,int AccessLevel, double HourlyWage, double TotalHoursWorkedForWeek){
		firstName = FirstName;
		lastName = LastName;
